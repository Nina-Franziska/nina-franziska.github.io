$(document).ready(function () {
  ...
  function injectLinkData(dataId) {
    ...
    switch (String($dataId)) {
      ...
      case "sitrekin":
        data = "Sub-Pages/ProjectDescriptions/ProjectInfo_Sitrekin.html";
        break;

      case "blackQueen":
        data = "Sub-Pages/ProjectDescriptions/ProjectInfo_blackQueen.html";
        break;
      ...
      case "sostr":
        data = "Sub-Pages/ProjectDescriptions/ProjectInfo_SØSTR.html";
        break;
